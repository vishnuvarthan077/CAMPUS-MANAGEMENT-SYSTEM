        ...
        <div className="auth-card">
          ...
          <div style={{ marginTop: '1.75rem', padding: '0.875rem', borderRadius: '0.75rem', background: 'rgba(0,0,0,0.02)', border: '1px solid var(--border-color)' }}>
            <span style={{ fontSize: '0.75rem', fontWeight: '700', color: 'var(--text-muted)', textTransform: 'uppercase', display: 'block', marginBottom: '0.5rem' }}>
              Quick Demo Accounts (run `npm run seed` in Backend/ first):
            </span>
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <button
                type="button"
                className="btn btn-sm btn-outline"
                onClick={() => setDemoAccount('student@campus.edu', 'Student@123')}
              >
                Student Demo
              </button>
              <button
                type="button"
                className="btn btn-sm btn-outline"
                onClick={() => setDemoAccount('faculty@campus.edu', 'Faculty@123')}
              >
                Faculty Demo
              </button>
              <button
                type="button"
                className="btn btn-sm btn-outline"
                onClick={() => setDemoAccount('admin@campus.edu', 'Admin@123')}
              >
                Admin Demo
              </button>
            </div>
