      ...
      <div className="page">
        ...
        <div className="page-header">
          <div>
            ...
            <div className="alert-error" style={{ background: 'var(--primary-light)', color: 'var(--primary)', borderColor: 'transparent', marginTop: '0.75rem' }}>
              <span>Demo data — attendance isn't wired to the backend yet.</span>
            </div>
          </div>
    ...
    <div className="page">
      ...
      <div className="page-header">
        <div>
          ...
          <div className="alert-error" style={{ background: 'var(--primary-light)', color: 'var(--primary)', borderColor: 'transparent', marginTop: '0.75rem' }}>
            <span>Demo data — this register is session-only and isn't wired to a backend yet. Nothing here is saved.</span>
          </div>
        </div>
