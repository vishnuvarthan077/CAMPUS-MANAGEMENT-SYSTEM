  ...
  return (
    <div className="table-wrapper">
      <table className="data-table">
        ...
        <tbody>
          {faculty.map((member) => (
            <tr key={member._id || member.employeeId}>
              {/* Faculty Name & Email */}
              <td>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.875rem' }}>
                  ...
                  <div>
                    <div className="cell-title">{member.user?.name || '—'}</div>
                    <div
              ...
              {/* Faculty ID */}
              <td>
                <span className="tag">{member.employeeId}</span>
              </td>

              {/* Department */}
              <td>
                <div style={{ fontWeight: '500' }}>{member.department?.name || '—'}</div>
              </td>
              ...
              <td>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                  <MapPin size={13} />
                  <span>{member.officeLocation || 'TBA'}</span>
                </div>
              </td>
